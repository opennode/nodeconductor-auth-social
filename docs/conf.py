...
# -*- coding: utf-8 -*-
#
# Waldur Auth Social documentation build configuration file.
#
...
from waldur_auth_social import __version__
...
htmlhelp_basename = 'waldur-auth-socialdoc'
...
latex_documents = [
  ('index', 'waldur-auth-social.tex', u'Waldur Auth Social Documentation',
   u'OpenNode', 'manual'),
]
...
man_pages = [
    ('index', 'waldur-auth-social', u'Waldur Auth Social Documentation',
     [u'OpenNode'], 1)
]
...
texinfo_documents = [
  ('index', 'Waldur Auth Social', u'Waldur Auth Social Documentation',
   u'OpenNode', 'waldur-auth-social', 'One line description of project.',
   'Miscellaneous'),
]
